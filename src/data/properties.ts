...
export const properties: Property[] = [
  {
    ...
    description: 'Modern 2BHK apartment in the heart of Satellite with excellent connectivity and amenities.',
    aiInsights: {
      bestMatch: true,
      neighborhood: {
        schools: 8,
      ...
      priceAnalysis: 'Fair value for the area. Similar properties rent for ₹22k-28k.',
  ...
  },
  {
    ...
    amenities: ['Clubhouse', 'Swimming Pool', 'Gym', 'Kids Play Area', 'Security'],
    description: 'Luxurious 3BHK villa in premium gated community with world-class amenities.',
    aiInsights: {
      neighborhood: {
        schools: 6,
        hospitals: 4,
      ...
      priceAnalysis: 'Slightly above market rate. Expected appreciation: 8-10% annually.',
  ...
  },
  {
    ...
    description: 'Compact 1BHK flat perfect for working professionals, close to railway station.',
    aiInsights: {
      bestMatch: true,
      neighborhood: {
        schools: 4,
  ...
  },
  {
    ...
    description: 'Premium office space in the heart of Ahmedabad\'s business district.',
    aiInsights: {
      neighborhood: {
        schools: 2,
        hospitals: 3,
  ...
  },
  {
    ...
    amenities: ['Gym', 'Swimming Pool', 'Club House', 'Garden', '24x7 Security'],
    description: 'Modern 2BHK apartment on SG Highway - Ahmedabad\'s prime investment corridor.',
    aiInsights: {
      bestMatch: true,
      neighborhood: {
        schools: 7,
      ...
      priceAnalysis: 'Great investment potential. Property values increased 12% last year.',
...
export const priceHeatmapData = [
  { area: 'SG Highway', avgPrice: 5500, zone: [23.0225, 72.5069], radius: 2000 },
  { area: 'Satellite', avgPrice: 4200, zone: [23.0225, 72.5714], radius: 1500 },
  { area: 'Bopal', avgPrice: 6200, zone: [23.0473, 72.4634], radius: 1800 },
  { area: 'Maninagar', avgPrice: 2800, zone: [22.9850, 72.6058], radius: 1200 },
  { area: 'Prahlad Nagar', avgPrice: 5800, zone: [23.0073, 72.5067], radius: 1000 },
  { area: 'Vastrapur', avgPrice: 5200, zone: [23.0395, 72.5693], radius: 1400 },
  { area: 'CG Road', avgPrice: 4800, zone: [23.0322, 72.5570], radius: 1300 }
];
