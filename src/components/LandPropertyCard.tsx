...
//   // Use the pre-mapped image URL from Index.tsx, or fall back to placeholder
//   const imageUrl =
//     property.images?.length > 0
//       ? property.images[0].startsWith("http://localhost:5000/")
//         ? property.images[0]
...
//                 <div className="flex items-center gap-1">
//                   <Eye className="w-3 h-3" />
//                   {property.aiInsights.demandIndicators.viewsThisWeek} views
//                   this week
//                 </div>
//                 <div className="flex items-center gap-1">
//                   <Users className="w-3 h-3" />
