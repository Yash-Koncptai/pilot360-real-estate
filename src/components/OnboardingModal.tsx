...
/* ------------------------------------------------------------------ */
/*  Custom Scroll Container – thin, always visible, styled             */
/* ------------------------------------------------------------------ */
const ScrollContainer = ({ children }: { children: React.ReactNode }) => (
  <div
    className="overflow-y-auto pr-3 flex-1"
    style={{
      scrollbarWidth: "thin",
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        ...
        <div className="flex justify-between p-6 pt-0 border-t bg-background/95 backdrop-blur-sm shrink-0">
          {step > 1 && (
            <Button
              variant="outline"
              onClick={() => setStep(step - 1)}
